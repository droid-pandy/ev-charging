#!/usr/bin/env python3
"""
Test LA to SF with 60% battery (more realistic)
"""
...
print("=" * 70)
print("Testing LA → SF with 60% Battery")
print("=" * 70)

# Scenario: LA to SF with 60% battery (180 miles range)
...
for i, station in enumerate(stations[:5], 1):
    if 'latitude' in station:
        ...
        print(f"   ✅ Reachable: {distance_miles <= current_range * 0.8}")
        print()
