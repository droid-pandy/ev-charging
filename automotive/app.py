...
# Sample prompts for VISTA agent
SAMPLE_PROMPTS = [
    "Find dealerships in San Francisco",
    "Diagnose my vehicle - customer ID: CUST001",
    "Find appointment slots at Crown Cars",
    "Show my appointments - customer code: CUST001"
]
...
def main():
    ...
    # Page configuration
    st.set_page_config(
        page_title="VISTA Agent Test Interface",
        layout="wide",
    ...
    st.markdown(
        """
        <h1 style="margin: 0; margin-bottom: 24px;">Agent Test Interface</h1>
        """,
        unsafe_allow_html=True
    )
    ...
    st.markdown(
        """
        <div class="info-box">
            <p><strong>About VISTA:</strong> This agent helps with dealership lookup, vehicle diagnostics, 
            and appointment management. Try the sample prompts below or ask your own questions.</p>
        </div>
        """,
        unsafe_allow_html=True
    )
